...
namespace Viajes365RestApi.Migrations.SqlServerMigrations
{
    ...
    [Migration("20210510120122_InitialCreate")]
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.Chat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ChatId = 1L,
                            Active = true,
                            Created = new DateTime(2021, 5, 10, 12, 1, 21, 545, DateTimeKind.Utc).AddTicks(9878),
                            CreatorId = 2L,
                            Email = "carolina_perez@gmail.com",
                            LastId = 2L,
                            Nick = "Caro",
                            Status = "aprobado",
                            Updated = new DateTime(2021, 5, 10, 12, 1, 21, 545, DateTimeKind.Utc).AddTicks(9878)
                        });
                });
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Code = 43437,
                            Created = new DateTime(2021, 5, 10, 12, 1, 21, 525, DateTimeKind.Utc).AddTicks(437),
                            CreatorId = 1L,
                            LastId = 1L,
                            Name = "Colón",
                            Updated = new DateTime(2021, 5, 10, 12, 1, 21, 525, DateTimeKind.Utc).AddTicks(437)
                        },
                        new
                        {
                            CityId = 2L,
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CityId = 5L,
                            Created = new DateTime(2021, 5, 10, 12, 1, 21, 506, DateTimeKind.Utc).AddTicks(3911),
                            CreatorId = 1L,
                            ...
                            Longitude = 0.0,
                            Note = "Por defecto",
                            Updated = new DateTime(2021, 5, 10, 12, 1, 21, 506, DateTimeKind.Utc).AddTicks(3911)
                        });
                });
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.Photo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PhotoId = 1L,
                            Active = true,
                            Created = new DateTime(2021, 5, 10, 12, 1, 21, 515, DateTimeKind.Utc).AddTicks(2659),
                            CreatorId = 1L,
                            ...
                            Updated = new DateTime(2021, 5, 10, 12, 1, 21, 515, DateTimeKind.Utc).AddTicks(2659)
                        },
                        new
                        {
                            PhotoId = 2L,
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = 1L,
                            Active = true,
                            Created = new DateTime(2021, 5, 10, 12, 1, 21, 541, DateTimeKind.Utc).AddTicks(7221),
                            CreatorId = 1L,
                            LastId = 1L,
                            RoleName = "Usuario",
                            Updated = new DateTime(2021, 5, 10, 12, 1, 21, 541, DateTimeKind.Utc).AddTicks(7221)
                        },
                        new
                        {
                            RoleId = 2L,
