...
namespace Viajes365RestApi.Migrations.SqlServerMigrations
{
    ...
    [Migration("20210510063936_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttractionTour", b =>
                {
                    ...
                    b.HasKey("AttractionsAttractionId", "ToursTourId");

                    b.HasIndex("ToursTourId");

                    b.ToTable("AttractionTour");
                });
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.Chat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ChatId = 1L,
                            Active = true,
                            Created = new DateTime(2021, 5, 10, 6, 39, 36, 206, DateTimeKind.Utc).AddTicks(8001),
                            CreatorId = 2L,
                            Email = "carolina_perez@gmail.com",
                            LastId = 2L,
                            Nick = "Caro",
                            Status = "aprobado",
                            Updated = new DateTime(2021, 5, 10, 6, 39, 36, 206, DateTimeKind.Utc).AddTicks(8001)
                        });
                });
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Code = 43437,
                            Created = new DateTime(2021, 5, 10, 6, 39, 36, 183, DateTimeKind.Utc).AddTicks(3671),
                            CreatorId = 1L,
                            LastId = 1L,
                            Name = "Colón",
                            Updated = new DateTime(2021, 5, 10, 6, 39, 36, 183, DateTimeKind.Utc).AddTicks(3671)
                        },
                        new
                        {
                            CityId = 2L,
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CityId = 5L,
                            Created = new DateTime(2021, 5, 10, 6, 39, 36, 165, DateTimeKind.Utc).AddTicks(3274),
                            CreatorId = 1L,
                            ...
                            Longitude = 0.0,
                            Note = "Por defecto",
                            Updated = new DateTime(2021, 5, 10, 6, 39, 36, 165, DateTimeKind.Utc).AddTicks(3274)
                        });
                });
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.Photo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PhotoId = 1L,
                            Active = true,
                            Created = new DateTime(2021, 5, 10, 6, 39, 36, 175, DateTimeKind.Utc).AddTicks(6909),
                            CreatorId = 1L,
                            ...
                            Updated = new DateTime(2021, 5, 10, 6, 39, 36, 175, DateTimeKind.Utc).AddTicks(6909)
                        },
                        new
                        {
                            PhotoId = 2L,
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = 1L,
                            Active = true,
                            Created = new DateTime(2021, 5, 10, 6, 39, 36, 200, DateTimeKind.Utc).AddTicks(3941),
                            CreatorId = 1L,
                            LastId = 1L,
                            RoleName = "Usuario",
                            Updated = new DateTime(2021, 5, 10, 6, 39, 36, 200, DateTimeKind.Utc).AddTicks(3941)
                        },
                        new
                        {
                            RoleId = 2L,
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.User", b =>
                {
                    b.HasOne("Viajes365RestApi.Entities.Photo", "Photo")
                        .WithMany()
