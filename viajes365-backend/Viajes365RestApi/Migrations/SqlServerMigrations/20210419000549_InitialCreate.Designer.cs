...
namespace Viajes365RestApi.Migrations.SqlServerMigrations
{
    ...
    [Migration("20210419000549_InitialCreate")]
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Code = 43437,
                            Created = new DateTime(2021, 4, 19, 0, 5, 48, 189, DateTimeKind.Utc).AddTicks(889),
                            CreatorId = 1L,
                            LastId = 1L,
                            Name = "Colón",
                            Updated = new DateTime(2021, 4, 19, 0, 5, 48, 189, DateTimeKind.Utc).AddTicks(889)
                        },
                        new
                        {
                            CityId = 2L,
            ...
            modelBuilder.Entity("Viajes365RestApi.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = 1L,
                            Active = true,
                            Created = new DateTime(2021, 4, 19, 0, 5, 48, 180, DateTimeKind.Utc).AddTicks(5109),
                            CreatorId = 1L,
                            LastId = 1L,
                            RoleName = "Usuario",
                            Updated = new DateTime(2021, 4, 19, 0, 5, 48, 180, DateTimeKind.Utc).AddTicks(5109)
                        },
                        new
                        {
                            RoleId = 2L,
