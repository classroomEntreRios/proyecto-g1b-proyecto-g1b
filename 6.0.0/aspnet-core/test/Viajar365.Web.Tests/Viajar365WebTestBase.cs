...
{
    public abstract class Viajar365WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Viajar365WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Viajar365WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Viajar365DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Viajar365DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Viajar365DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Viajar365DbContext, Task<T>> func)
        {
            T result;
