...
const routes: Routes = [
  ...
  // {
  //   path: 'attractions',
  //   redirectTo: 'attractions/attractionslist',
  //   pathMatch: 'full',
  // },
  {
    path: 'attractions',
  ...
  { path: 'tours', redirectTo: 'underconstruction', pathMatch: 'full' },
  ...
  {
    path: 'locations',
    redirectTo: 'locations/locationslist',
    pathMatch: 'full',
  },
  // { path: 'photos', redirectTo: 'photos/photoslist', pathMatch: 'full' },
  { path: 'photos', redirectTo: 'underconstruction', pathMatch: 'full' },
  // { path: 'weathers', redirectTo: 'weathers/weatherslist', pathMatch: 'full' },
  { path: 'weathers', redirectTo: 'underconstruction', pathMatch: 'full' },
  {
